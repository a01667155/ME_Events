...
class CASME2Dataset(Dataset):
    def __init__(self):
        ...
        self.video_folder_path = r'D:\PythonCourse\ME_Recognition\Data\RGB_videos'
        self.transform = transforms.Compose([
            ResizeVideo((112, 112)),
            transforms.Lambda(self.normalize_to_float)  # Normalizar a [0, 1]
            ])
        
        self.max_length = 154 # self._get_max_length()
